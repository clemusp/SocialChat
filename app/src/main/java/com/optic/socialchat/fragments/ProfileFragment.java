...
import com.optic.socialchat.activities.EditProfileActivity;
...
public class ProfileFragment extends Fragment {
    ...
    private void checkIfExistPost() {
        mNewPublicProvider.getPostByUser(mAuthProvider.getUid()).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onStart() {
        super.onStart();
        Query query = mNewPublicProvider.getPostByUser(mAuthProvider.getUid());
    ...
    private void getPostNumber(){
        mNewPublicProvider.getPostByUser(mAuthProvider.getUid()).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
