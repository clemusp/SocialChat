        ...
        mAuthProvider.googleLogin(acct).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(MainActivity.this, "No se pudo iniciar sesión con tu cuenta de Google", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    mUsersProvider.create(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(MainActivity.this, "No se pudo almacenar al información del Usuario", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        ...
        mAuthProvider.login(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(MainActivity.this, "El email o la contraseña no son correctas", Toast.LENGTH_SHORT).show();
                }
            }
        });
